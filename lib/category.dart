...
class _CategoryState extends State<Category> {
  ...
  getNewsAbout(String about) async {
    ...
    if(about == "Top News" || about == "Bangladesh"){
      ...
      url = "https://newsapi.org/v2/everything?q=$about&from=2023-04-11&sortBy=publishedAt&apiKey=11a0a87575bf42d786e1b447b6c4ef5f";
    }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 25,letterSpacing: 9),
                      ),
                    ),
                  ],
                ),
